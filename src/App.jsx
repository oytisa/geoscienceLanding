...
function App() {
  ...
  // Define dropdown items for GeoGlobe menu
  const geoglobeItems = [
    { 
      label: "Seismic Monitor", 
      href: "#seismic", 
      description: "Real-time earthquake tracking and alerts",
      icon: <Activity size={20} />,
      emoji: "📡"
    },
    { 
      label: "Earthquake Hazard", 
      href: "https://maps.openquake.org/map/gshm-2023-1/#6/9.482/42.860", 
      description: "Global Seismic Hazard Map (2023.1) - GEM Foundation",
      icon: <Shield size={20} />,
      emoji: "⚠️",
      external: true
    },
  ...
  // Define dropdown items for Software menu
  const softwareItems = [
    { 
      label: "GeoLibre", 
      href: "https://viewer.geolibre.app/", 
      description: "Open-source geospatial data visualization platform",
      icon: <Code size={20} />,
      emoji: "🖥️",
      external: true
    },
      ...
      <nav className="navbar">
        <div className="nav-container">
          <div className="nav-wrapper">
            {/* Logo with GIE Image - Fully Visible */}
            <div className="logo">
              <div className="logo-icon">
                <img 
                  src="https://gie.gov.et/images/gielogo.jpg" 
                  alt="Geological Institute of Ethiopia Logo" 
                  className="logo-image"
                />
              </div>
              <div className="logo-text-wrapper">
                <span className="logo-text">EIGIS</span>
                <span className="logo-subtitle">EIGIS</span>
              </div>
